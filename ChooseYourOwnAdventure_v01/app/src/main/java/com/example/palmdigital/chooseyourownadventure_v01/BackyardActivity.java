...
public class BackyardActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonFaintObject = findViewById(R.id.buttonRight_Faint);
        Button buttonScreamObject = findViewById(R.id.buttonLeft_Scream);
    ...
    {
      if (v.getId() == R.id.buttonLeft_Scream)
      {
